...
class TestAuthenticatePost200Response(unittest.TestCase):
    """AuthenticatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatePost200Response:
        """Test AuthenticatePost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatePost200Response`
        """
        model = AuthenticatePost200Response()
        if include_optional:
            return AuthenticatePost200Response(
                status = '',
                return_value = None
            )
        else:
    ...
    def testAuthenticatePost200Response(self):
        """Test AuthenticatePost200Response"""
