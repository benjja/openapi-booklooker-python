...
class TestUploadApi(unittest.TestCase):
    ...
    def test_file_import_post(self) -> None:
        """Test case for file_import_post

        Upload von Angebots- oder Bild-Dateien
        """
        pass

    def test_file_status_get(self) -> None:
        """Test case for file_status_get

        Abfragen des Status einer hochgeladenen Angebotsdatei
        """
        pass

    def test_import_status_get(self) -> None:
